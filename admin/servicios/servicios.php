...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 flex flex-col min-w-0 bg-gray-100 overflow-y-auto">
            ...
            <div class="p-6 md:p-10">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                    <div>
                        ...
                        <p class="text-gray-500 mt-1">Administra los servicios y precios de la clínica</p>
                    </div>
                ...
                <div id="contenedor-servicios" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div
            ...
            <?php include 'componentes/modal-crear-servicio.php'; ?>
